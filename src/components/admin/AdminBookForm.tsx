...
const AdminBookForm = ({ onSuccess, existingBook }: AdminBookFormProps) => {
  ...
  const [displayDescription, setDisplayDescription] = useState(existingBook?.displayDescription || false);
        ...
        <div className="mb-4">
          ...
          <div className="mt-3 flex items-center">
            <input
              ...
              className="h-4 w-4 text-primary focus:ring-primary border-gray-600 rounded bg-[#2a2a2a]"
              disabled={uploading}
            />
            <label htmlFor="displayDescription" className="ml-2 block text-sm text-gray-300">
              Display description on book page
            </label>
          </div>
        </div>
